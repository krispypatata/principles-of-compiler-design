...
def exec_lolcode():
    ...
    for token_data in tokens:
        lexeme, classification, _ = token_data
        lexemeTable.insert("", "end", values=(lexeme, classification))
    ...
    for identifier, value in global_symbol_table.symbols.items():
        symbolTable.insert("", "end", values=(identifier, str(value)))
...
submitButton = tk.Button(inputPanel, text="Submit Input", font=titleFont, command=submit_input)
